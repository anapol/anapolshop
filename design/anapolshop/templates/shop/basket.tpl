...
<tr class="bglight">
    <td colspan="{*7*}5"><input type="hidden" name="ProductItemIDList[]" value="{$Basket:ProductItem:item.id}" />
...
<tr class="bglight">
    <td colspan="{*6*}4"><input class="button" type="submit" name="StoreChangesButton" value="{'Update'|i18n('design/ezwebin/shop/basket')}" /></td>
...
<tr>
  <td colspan="{*7*}5" style="padding: 0;">
...
<tr>
     <td colspan="{*5*}4">
     <b>Poštovné:</b> {if $shipping_info.description} {$shipping_info.description}{else} nezadáno{/if} (<a href={$shipping_info.management_link|ezurl}>změnit</a>):
     </td>
{*     <td>
